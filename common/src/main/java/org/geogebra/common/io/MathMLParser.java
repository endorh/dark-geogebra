...
public class MathMLParser {
	/**
	 * The placeholder for blocks in substitutions. If a substitution contains
	 * a block placeholder it is replaced by the LaTeX representation of the
	 * following block.<br>
	 * Syntax: PH_BLOCK_START + blockNumber + PH_BLOCK_END, e.g. '#BLOCK1#'.
	 */
	...
	/**
	 * TODO (complete MathML blocks only?):
	 * Parses MathML code into LaTeX code using the substitution
	 * table generated by the constructor.
	 * <br>
	 ...
	 * "HTML wrapped" notation starting with an entity for the ampersand sign
	 * (e.g. '&amp;amp;equals;').
	 * 
	 * @param strBuf0
	 *            a String containing the MathML code to parse
	 ...
	 *            skipUnknownEntities
	 * @return a StringBuilder containing the LaTeX representation of the input
	 */
