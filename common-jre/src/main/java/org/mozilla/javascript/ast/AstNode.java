...
//     }
    ...
    protected static class DebugPrintVisitor implements NodeVisitor {
        ...
        private String makeIndent(int depth) {
            ...
            sb.append(" ".repeat(Math.max(0, (DEBUG_INDENT * depth))));
            return sb.toString();
        }
