...
public class SVGFontTable {
	...
	public String toString() {
		...
		while (fonts.hasMoreElements()) {
			...
			// added horiz-adv-x="0" as it's compulsory according to
	 ...
	 * <BR>
	 * will result to:<BR>
	 * <code>java.awt.Font[family=SansSerif,name=SansSerif,style=plain,size=100]</code>
	 * <BR>
	 * <BR>
	 *
	...
	/**
	 * Replaces TextAttribute.FAMILY by values of replaceFonts. When a font
	 * created using the result of this method the transformation would be:
	 *
	 * <code>java.awt.Font[family=SansSerif,name=SansSerif,style=plain,size=30]</code>
	 * <BR>
	 * will result to:<BR>
	 * <code>java.awt.Font[family=SansSerif,name=Helvetica,style=plain,size=30]</code>
	 * <BR>
	 * <BR>
	 *
