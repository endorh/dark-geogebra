...
public class DelegateTree<V, E> extends GraphDecorator<V, E>
	 ...
	 *             if the root was previously set
	 */
	@Override
	 ...
	 * @param parent
	 *            the existing parent to attach the child to
	 * @param child
	 *            the new child to add to the tree as a child of parent
	 * @param edgeType
	 *            must be EdgeType.DIRECTED or the underlying graph may throw an
	 *            exception
